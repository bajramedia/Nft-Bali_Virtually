<section class="py-16 md:py-24 ">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-semibold mb-6" style="font-family: 'Aldrich', sans-serif;">Impact &amp; Giving</h2>
            <p class="color-text-white max-w-6xl mx-auto mb-10 text-base md:text-lg">
            ...
            <p class="color-text-white max-w-6xl mx-auto text-base md:text-lg">
                Each NFT sold is not just a digital collectible, but also a part of an effort to create positive change. We are committed to <span class="text-teal-400 font-semibold">donating 20%</span> of each NFT sale to the people of Bali. The funds raised will be used to support education, preserve culture,
            </p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-8">
            @php
                // Ambil data projects dari controller untuk featured tours
                ...
                <div class="bg-[#232323] rounded-2xl overflow-hidden shadow-lg flex flex-col items-center">
                    ...
                    <div class="p-6 flex flex-col flex-1 w-full">
                        ...
                        <div class="mb-2 flex justify-center">
                            <span class="text-xs color-text-white tracking-wide">USD ${{ number_format($project['raised_amount']) }} / USD ${{ number_format($project['target_amount']) }}</span>
                        </div>
                        <div class="w-full flex flex-col items-center mb-2">
                            <div class="w-4/5 color-text-white rounded-full h-2.5 bg-[#353535] relative">
                                <div class="bg-teal-400 h-2.5 rounded-full absolute top-0 left-0" style="width: {{ round($project['raised_amount'] / $project['target_amount'] * 100) }}%"></div>
                            </div>
                        </div>
